...
def trigger_engine(d):
    last = d.get('last')
    bull_trigger = d.get('liq_above_htf') or d.get('liq_above_1') or d.get('prev_15m_high') or d.get('prev_5m_high')
    bear_trigger = d.get('liq_below_htf') or d.get('liq_below_1') or d.get('prev_15m_low') or d.get('prev_5m_low')
    ...
    if last is not None:
        ...
        min_gap = max(atr15_base * 0.65, last * 0.0035)
